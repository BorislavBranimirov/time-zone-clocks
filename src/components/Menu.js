...
const Menu = (props) => {
    ...
    return (
        <div>
            {hideMenu ? (
                <button className="reveal-menu-btn" onClick={() => setHideMenu(false)}>
                    <i className="fas fa-angle-right fa-3x"></i>
                </button>
            ) : (
                    <div className="menu" ref={menuRef}>
                        <button className="reveal-menu-btn" onClick={() => setHideMenu(true)}>
                        ...
                        <div className="global-settings-form">
                            ...
                            <div className="meridiem">
                                <label htmlFor="meridiem">12-hour clock:
                                <input
                                    type="checkbox"
                                    id="meridiem"
                                    checked={props.meridiem}
                                    onChange={() => {
                                        localStorage.setItem('meridiem', !props.meridiem);
                        ...
                        <div className="create-clock-form">
                            ...
                            <button className="create-clock-btn" onClick={handleClick}>Create Clock</button>
                        </div>
                    </div>
                )}
        </div>
